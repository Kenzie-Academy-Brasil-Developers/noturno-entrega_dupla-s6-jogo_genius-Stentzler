...
function criaSequenciaDasLuzes() {
  //aqui pode ser alterado o numero de rodadas
  sequenciaDasLuzes = [];
  numeroDeRodadas = 5;
...
function piscaBotao(valorDeUmAQuatro) {
  if (valorDeUmAQuatro == 1) {
    ...
    const verdeFlashStoper = () => {
      setTimeout(verdeFlash, 300);
    };
    verdeFlashStoper();
  ...
  if (valorDeUmAQuatro == 2) {
    ...
    const amareloFlashStoper = () => {
      setTimeout(amareloFlash, 300);
    };
    amareloFlashStoper();
  ...
  if (valorDeUmAQuatro == 3) {
    ...
    const vermelhoFlashStoper = () => {
      setTimeout(vermelhoFlash, 300);
    };
    vermelhoFlashStoper();
  ...
  if (valorDeUmAQuatro == 4) {
    ...
    const azulFlashStoper = () => {
      setTimeout(azulFlash, 300);
    };
    azulFlashStoper();
...
function check(sequenciaDoUsuario) {
  ...
  sequenciaDoUsuario.forEach((elem, index) => {
    if (elem == sequenciaDasLuzes[index] && acertou == true) {
      acertou = true;
    } else {
      acertou = false;
    }
...
function esperandoCondicao() {
  if (sequenciaDoUsuario.length < rodada) {
    setTimeout(esperandoCondicao, 1000);
  } else {
